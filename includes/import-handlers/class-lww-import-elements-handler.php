<?php
/**
 * Import-Handler für Rebrickable 'elements.csv' (v16.0)
...
class LWW_Import_Elements_Handler extends LWW_Import_Handler_Base {
    ...
    public function process_row($job_id, $row_data_raw, $header_map) {
        ...
        $design_id = sanitize_text_field($data['design_id'] ?? '');
        ...
        $part_post_id = self::find_post_by_meta('lww_part', '_lww_part_num', $part_num);
        ...
        $color_post_id = self::find_color_by_rebrickable_id($color_id_external);
