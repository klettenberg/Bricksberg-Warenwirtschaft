<?php
/**
 * Modul: Job Status Registrierung (v16.1)
 * Registriert die Custom Post Status für 'lww_job'.
 * 
 * UPDATE: Status global registriert, damit Cronjobs sie finden können.
 */
...
function lww_register_job_post_statuses() {
    // Entfernt: is_admin() check. Cronjobs laufen nicht immer im Admin-Kontext.
